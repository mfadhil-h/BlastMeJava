    ...
    public HashMap<String, String> convertHashMapObjectToString(HashMap<String, Object> mapIn) {
        ...
        for (Map.Entry<String, Object> entry : mapIn.entrySet()) {
            try {
                ...
                logger.debug("Failed to convert Object HashMap to String HashMap. Error: " + e);
                logger.error("Failed to convert Object HashMap to String HashMap. Error: " + e);
            }
        }
    ...
    public JSONObject convertHashMapJSONToJSON(HashMap<String, JSONObject> mapIn) {
        ...
        if (mapIn.size() > 0) {
            for (Map.Entry<String, JSONObject> entry : mapIn.entrySet()) {
                if ((entry.getKey() != null) && (entry.getValue() != null)) {
                    jsonHasil.put(entry.getKey(), entry.getValue().toString());
                }
            }
        }
...
//		hasil = hasil + arrXML;
    ...
    public String convertJSONToXMLStringWithKeyAsXMLTag(JSONObject jsonParameter, Boolean TagUseLowerCase, Boolean withRootTag, String rootTag) {
        ...
        while (itrJsonParameter.hasNext()) {
            ...
            if (jsonParameter.get(key) instanceof String) {
                ...
                if (isValidJSONObject(tempContent)) {
                ...
                } else if (isValidJSONArray(tempContent)) {
        ...
        if (jsonData instanceof JSONObject) {
            ...
            for (int x = 0; x < theJSONArray.length(); x++) {
                if (theJSONArray.get(x) instanceof String) {
                    ...
                    logger.debug(titikIndent + "array index: " + x + " : " + theContent);
                    ...
                    // reprint
                    logger.debug(titikIndent + "array index: " + x + " : ");
    ...
    public Date setTimeInDate(final Date date, final int hourOfDay, final int minute, final int second, final int millisecond) {
        ...
        logger.debug("Function setTimeInDate - finalSetDateTime: " + finalSetDateTime);
    ...
    public Date getLastPeriodMonths(final int monthDiff) {
        ...
        logger.debug("Function getLastPeriodMonths - monthDiff " + monthDiff + " from this month is " + cal.getTime());
    ...
    public Date getLastPeriodMonthBegining(final int monthDiff) {
        ...
        logger.debug("Function getLastPeriodMonthBegining - first day of monthDiff " + monthDiff + " from today is " + theEarlyDateTimeOfTheLastMonth.toString());
    ...
    public Date getLastPeriodMonthEnding(final int monthDiff) {
        ...
        logger.debug("Function getLastPeriodMonthEnding - last day of monthDiff " + monthDiff + " from today is " + theLastDateTimeOfTheLastMonth.toString());
    ...
    private Cipher getCipher(int cipherMode, String encryptionKey) throws Exception {
        ...
        SecretKeySpec keySpecification = new SecretKeySpec(encryptionKey.getBytes(StandardCharsets.UTF_8), encryptionAlgorithm);
    ...
    public Date getStartOfWeek(Date theDate) {
        ...
        logger.debug("Function getStartOfWeek - theDate: " + theDate + ", startOfWeekDate: " + startOfWeekDate);
...
//			logger.debug("Function getTimeLinePeriod - Putting theDate " + sdfPastiDateTime.format(theDate) + " into listTimeLine.");
    ...
    public HashMap<String, String> hitHTTPSGetGeneral(String traceCode, String URL, String getParameter, JSONObject jsonHeaders) {
        ...
        if (jsonHeaders != null) {
            logger.debug("Function hitHTTPSGetGeneral - Incoming parameter - url: " + URL + ", postParameter: " + getParameter + ", headers: " + jsonHeaders);
        } else {
...
//		            sslsf).build();
            ...
            ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
                ...
                public String handleResponse(HttpResponse response) throws IOException {
                    ...
                    System.out.println("----- resp. statusCode: " + statusCode);
                    ...
                    if (statusCode >= 200 && statusCode < 300) {
                        ...
                        logger.debug(traceCode + " - Function hitHTTPSGetGeneral - Hit vendor SUCCESS. HTTP STATUS: " +
                                statusCode + ", BODY: " + HTTPBodyResponse);
                    } else {
            ...
            logger.info(traceCode + " - Function hitClientGetGeneral - System error while querying vendor HTTP GET server. Error: " + e);
    ...
    public HashMap<String, String> hitHTTPGetGeneral(String traceCode, String URL, String getParameter, JSONObject jsonHeaders) {
        ...
        if (jsonHeaders != null) {
            logger.debug("Function hitHTTPGetGeneral - Incoming parameter - url: " + URL + ", postParameter: " + getParameter + ", headers: " + jsonHeaders);
        } else {
    ...
    public HashMap<String, String> hitHTTPSPostFormUrl(String messageId, String url, List<NameValuePair> formParameters, JSONObject jsonHeaders) {
        ...
        try {
            ...
            logger.debug("Function hitHTTPPost - Incoming parameter - response statusCode: " + statusCode);
            ...
            logger.debug("Function hitHTTPPost - Incoming parameter - response jsonHeader: " + jsonHeader);
            ...
            logger.info("Function hitClientPost - System error while querying vendor. Error: " + e);
            ...
            try {
                ...
                logger.info("Function hitClientPost - System error while closing the httpclient. Error: " + e);
            }
        }
    ...
    public HashMap<String, String> hitHTTPPostGeneralNonForm(String traceCode, String URL, String postParameter, JSONObject jsonHeaders) {
        if (jsonHeaders != null) {
            logger.debug("Function hitHTTPPostGeneralNonForm - Incoming parameter - url: " + URL + ", postParameter: " + postParameter + ", headers: " + jsonHeaders);
        } else {
        ...
        try {
            ...
            HttpEntity entity = new ByteArrayEntity(hitRequestBody.getBytes(StandardCharsets.UTF_8));
            ...
            logger.debug("Function hitHTTPPostGeneralNonForm - Incoming parameter - response statusCode: " + hitResultHttpStatusCode);
            ...
            logger.debug("Function hitHTTPPost - Incoming parameter - response jsonHeader: " + hitResultHttpHeader);
            ...
            logger.info("Function hitClientPost - System error while querying vendor Dompas. Error: " + e);
    ...
    public HashMap<String, String> hitHTTPPost(String url, String postParameter, String contentType) {
        ...
        try {
            ...
            HttpEntity entity = new ByteArrayEntity(postParameter.getBytes(StandardCharsets.UTF_8));
    ...
    public String generateIdFromStringName(String theName) {
        ...
        hasil = theName.charAt(0) + theName.substring(theName.length() - 2) + sdf.format(new Date());
