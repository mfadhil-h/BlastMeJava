...
public class ContextualProcessorAtlasat {
	private static Logger logger;	
	private Tool tool;
	
	private static String queueBatchToProcess = "CONTEXTUAL_BLAST_TOPUSH_BATCHID_ATLASAT";
...
//	private static RedisCommands<String, String> redisCommand;
	...
	public ContextualProcessorAtlasat() {
		// Set timezone
		...
		// Setup logger
		logger = LogManager.getLogger("CONTEXTUAL_PROCESSOR_ATLASAT");
...
//							+ "processed_datetime, processed_username) VALUES (?, ?, ?, ?, ?, ?, ?)");
	...
	public static void main(String[] args) {
		...
		ContextualProcessorAtlasat processor = new ContextualProcessorAtlasat();
		processor.readQueue();
	}
