...
public class VoiceBlastProcessorIndosat {
	private static Logger logger;	
	private Tool tool;
	
	private static String queueBatchToProcess = "VOICE_BLAST_TOPUSH_BATCHID_INDOSAT";
...
//	private static RedisCommands<String, String> redisCommand;
	...
	public VoiceBlastProcessorIndosat() {
		// Set timezone
		...
		// Setup logger
		logger = LogManager.getLogger("VOICEBLAST_PROCESSOR_INDOSAT");
...
//    		redisCommand = redisPooler.redisInitiateConnection();
	...
	public static void main(String[] args) {
		...
		VoiceBlastProcessorIndosat processor = new VoiceBlastProcessorIndosat();
		processor.readQueue();
	}
