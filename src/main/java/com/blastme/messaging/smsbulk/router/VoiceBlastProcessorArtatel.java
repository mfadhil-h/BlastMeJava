...
public class VoiceBlastProcessorArtatel {
	private static Logger logger;	
	private Tool tool;
	
	private static String queueBatchToProcess = "VOICE_BLAST_TOPUSH_BATCHID_ARTATEL";
...
//	private static RedisCommands<String, String> redisCommand;
	...
	public VoiceBlastProcessorArtatel() {
		// Set timezone
		...
		// Setup logger
		logger = LogManager.getLogger("VOICEBLAST_PROCESSOR_ARTATEL");
		...
		batchFileDirectory = "/app/web_artatel/uploadedBNumberMsgParameter/";
...
//    		redisCommand = redisPooler.redisInitiateConnection();
	...
	public static void main(String[] args) {
		...
		VoiceBlastProcessorArtatel processor = new VoiceBlastProcessorArtatel();
		processor.readQueue();
	}
