...
public class VoiceBlastProcessorAtlasat {
	private static Logger logger;	
	private Tool tool;
	
	private static String queueBatchToProcess = "VOICE_BLAST_TOPUSH_BATCHID_ATLASAT";
...
//	private static RedisCommands<String, String> redisCommand;
	...
	public VoiceBlastProcessorAtlasat() {
		// Set timezone
...
//    		redisCommand = redisPooler.redisInitiateConnection();
	...
	public static void main(String[] args) {
		...
		VoiceBlastProcessorAtlasat processor = new VoiceBlastProcessorAtlasat();
		processor.readQueue();
	}
