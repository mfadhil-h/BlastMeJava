...
public class VoiceBlastProcessorTelin {
	private static Logger logger;	
	private Tool tool;
	
	private static String queueBatchToProcess = "VOICE_BLAST_TOPUSH_BATCHID_TELIN";
...
//	private static RedisCommands<String, String> redisCommand;
	...
	public VoiceBlastProcessorTelin() {
		// Set timezone
		...
		// Setup logger
		logger = LogManager.getLogger("VOICEBLAST_PROCESSOR_ATLASAT");
...
//    		redisCommand = redisPooler.redisInitiateConnection();
	...
	public static void main(String[] args) {
		...
		System.out.println("Starting TELIN Voice Blast Processor ...");
		
		VoiceBlastProcessorTelin processor = new VoiceBlastProcessorTelin();
		processor.readQueue();
	}
