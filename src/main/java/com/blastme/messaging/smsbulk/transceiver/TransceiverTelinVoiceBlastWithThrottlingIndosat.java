...
public class TransceiverTelinVoiceBlastWithThrottlingIndosat {
	...
	public TransceiverTelinVoiceBlastWithThrottlingIndosat(String queueName, int theTPS) {
		// Set timezone
	...
	public static void main(String[] args) {
		...
		TransceiverTelinVoiceBlastWithThrottlingIndosat cpass = new TransceiverTelinVoiceBlastWithThrottlingIndosat(queueTelin, theTPS);
...
//			jsonQueuedMessage.put("routedVendorId", routedVendorId);	
			...
			try{
				...
				if (!msisdn.startsWith("+")) {
					msisdn = "+" + msisdn; // as required by Indosat
				}
