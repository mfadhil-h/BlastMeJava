...
public class BlastMeSMPPServerTLS21 {
	...
	public BlastMeSMPPServerTLS21() {
		...
		// Setup logger
		logger = LogManager.getLogger("SMPP_SERVER_TLS");
	...
	public static void main(String[] args) {
		BlastMeSMPPServerTLS21 blastmeSmppServer = new BlastMeSMPPServerTLS21();
	...
	public static class DefaultSmppServerHandler implements SmppServerHandler {
        ...
        public void sessionBindRequested(Long sessionId, SmppSessionConfiguration sessionConfiguration, final BaseBind bindRequest) throws SmppProcessingException {
			...
			LoggingPooler.doLog(logger, "DEBUG", "EliandrieSMPPServerNeo - DefaultSmppServerHandler", "sessionBindRequested", false, false, true, "", 
...
//						
//						if (theSysId != null && theSysId.length() > 0 ) {
//							// Get sysSessionId
//							SmppServerSession theSession = null;
//							for (Entry<String, SmppServerSession> entry: mapSession.entrySet()) {
//								if (entry.getKey().startsWith(theSysId)) {
...
//						} else {
//							LoggingPooler.doLog(logger, "DEBUG", "BlastMeSMPPServer - ClientDLRSubmmiter", "proccessClientMOWABAMessage", false, false, false, waMessageId, 
//									"Failed to send message to client for the sessionId is NOT UP.", null);
//						}
//					}
//				} catch (Exception e) {
//					LoggingPooler.doLog(logger, "INFO", "sendingDLR", "proccessClientMOWABAMessage", true, false, true, "", 
//							"Failed to process the DLR message.", e);
//					SMPPDLRPooler.sendSMPPPreviouslyFailedDLR("", queueMessage);
//				}
//			}
...
//		    			}
		    			...
		    			if (allSMSMessage == null || allSMSMessage.length == 0) {
			                ...
			                System.out.println("Processing messageId: HOHO" + messageId);
						...
						System.out.println("NOT UDH - isUdh: " + isUdh);
		                ...
		                // Run thread smppIncomingTrxProcessor
		                System.out.println("Processing messageId TLV: " + messageId);
    		...
    		private void doProcessTheSMS() {
    			...
    			try {
    				...
    				if (!errorCode.trim().startsWith("00")) {
    					...
    					jsonIncoming.put("receiverType", "SMPPTLS"); // SMPP and HTTP only
    					jsonIncoming.put("smsChannel", "SMPPTLS");
